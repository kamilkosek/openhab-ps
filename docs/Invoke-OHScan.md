...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/invoke-ohscan
schema: 2.0.0
---
...
### Scan (Default)
```
Invoke-OHScan -BindingId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ScanViaIdentity
```
Invoke-OHScan -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
