...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohruleaction
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHRuleAction -RuleUid <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHRuleAction -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IActionDto
