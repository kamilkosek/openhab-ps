...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohavailablefirmware
schema: 2.0.0
---

# Get-OHAvailableFirmware
...
### Get (Default)
```
Get-OHAvailableFirmware -ThingUid <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHAvailableFirmware -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IFirmwareDto
