...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohapitoken
schema: 2.0.0
---
...
### Remove (Default)
```
Remove-OHApiToken -Name <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHApiToken -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
