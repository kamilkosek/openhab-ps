...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohthing
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHThing [-Summary] [-AcceptLanguage <String>] [<CommonParameters>]
```

### Get1
```
Get-OHThing -ThingUid <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHThing -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IEnrichedThingDto
