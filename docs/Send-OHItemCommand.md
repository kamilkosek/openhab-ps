...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/send-ohitemcommand
schema: 2.0.0
---
...
### Send (Default)
```
Send-OHItemCommand -Itemname <String> -Data <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SendViaIdentity
```
Send-OHItemCommand -InputObject <IOpenHabRestApiIdentity> -Data <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
