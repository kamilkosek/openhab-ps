...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/uninstall-ohaddon
schema: 2.0.0
---
...
### Uninstall (Default)
```
Uninstall-OHAddon -AddonId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UninstallViaIdentity
```
Uninstall-OHAddon -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: UninstallViaIdentity
Aliases:
