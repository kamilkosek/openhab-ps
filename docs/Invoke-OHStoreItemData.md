...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/invoke-ohstoreitemdata
schema: 2.0.0
---

# Invoke-OHStoreItemData
...
### Store (Default)
```
Invoke-OHStoreItemData -Itemname <String> -State <String> -Time <String> [-ServiceId <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StoreViaIdentity
```
Invoke-OHStoreItemData -InputObject <IOpenHabRestApiIdentity> -State <String> -Time <String>
 [-ServiceId <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: StoreViaIdentity
Aliases:
