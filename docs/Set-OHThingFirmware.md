...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/set-ohthingfirmware
schema: 2.0.0
---
...
### Update (Default)
```
Set-OHThingFirmware -FirmwareVersion <String> -ThingUid <String> [-AcceptLanguage <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-OHThingFirmware -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru] [-Confirm]
