...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohmemberfromgroupitem
schema: 2.0.0
---

# Remove-OHMemberFromGroupItem
...
### Remove (Default)
```
Remove-OHMemberFromGroupItem -Itemname <String> -MemberItemName <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHMemberFromGroupItem -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
