...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohitemfromregistry
schema: 2.0.0
---

# Remove-OHItemFromRegistry
...
### Remove (Default)
```
Remove-OHItemFromRegistry -Itemname <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHItemFromRegistry -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
