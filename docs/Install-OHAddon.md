...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/install-ohaddon
schema: 2.0.0
---
...
### Install (Default)
```
Install-OHAddon -AddonId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### InstallViaIdentity
```
Install-OHAddon -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
