...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohuicomponentfromnamingroom
schema: 2.0.0
---

# Remove-OHUiComponentFromnamingroom
...
### Remove (Default)
```
Remove-OHUiComponentFromnamingroom -ComponentUid <String> -Namingroom <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHUiComponentFromnamingroom -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
