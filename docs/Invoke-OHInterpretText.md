...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/invoke-ohinterprettext
schema: 2.0.0
---

# Invoke-OHInterpretText
...
### Interpret1 (Default)
```
Invoke-OHInterpretText -Data <String> [-AcceptLanguage <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Interpret
```
Invoke-OHInterpretText -Id <String> -Data <String> [-AcceptLanguage <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### InterpretViaIdentity
```
Invoke-OHInterpretText -InputObject <IOpenHabRestApiIdentity> -Data <String> [-AcceptLanguage <String>]
...
Parameter Sets: InterpretViaIdentity
Aliases:
