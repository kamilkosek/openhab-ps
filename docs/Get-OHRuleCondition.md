...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohrulecondition
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHRuleCondition -RuleUid <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHRuleCondition -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IConditionDto
