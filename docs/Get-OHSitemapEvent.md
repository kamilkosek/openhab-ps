...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohsitemapevent
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHSitemapEvent -Subscriptionid <String> [-Pageid <String>] [-Sitemap <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHSitemapEvent -InputObject <IOpenHabRestApiIdentity> [-Pageid <String>] [-Sitemap <String>] [-PassThru]
 [<CommonParameters>]
```
