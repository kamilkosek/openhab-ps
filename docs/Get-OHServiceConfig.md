...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohserviceconfig
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHServiceConfig -ServiceId <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHServiceConfig -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
