...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohgallerywidgetlist
schema: 2.0.0
---

# Get-OHGalleryWidgetList
...
### Get (Default)
```
Get-OHGalleryWidgetList -GalleryName <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHGalleryWidgetList -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IGalleryWidgetsListItem
