...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohserviceconfig
schema: 2.0.0
---

# Remove-OHServiceConfig
...
### Delete (Default)
```
Remove-OHServiceConfig -ServiceId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-OHServiceConfig -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
