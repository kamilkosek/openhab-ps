...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/add-ohtagtoitem
schema: 2.0.0
---
...
### Add (Default)
```
Add-OHTagToItem -Itemname <String> -Tag <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AddViaIdentity
```
Add-OHTagToItem -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
