...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/set-ohruleconfiguration
schema: 2.0.0
---

# Set-OHRuleConfiguration
...
```
Set-OHRuleConfiguration -RuleUid <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Set-OHRuleConfiguration -RuleUid <String> -Body <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-OHRuleConfiguration -InputObject <IOpenHabRestApiIdentity> -Body <Hashtable> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-OHRuleConfiguration -InputObject <IOpenHabRestApiIdentity> [-AdditionalProperties <Hashtable>] [-PassThru]
