...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/invoke-ohpolldata
schema: 2.0.0
---
...
### Poll (Default)
```
Invoke-OHPollData -Pageid <String> -Sitemapname <String> [-IncludeHidden] [-Subscriptionid <String>]
 [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### PollViaIdentity
```
Invoke-OHPollData -InputObject <IOpenHabRestApiIdentity> [-IncludeHidden] [-Subscriptionid <String>]
 [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```
...
Parameter Sets: PollViaIdentity
Aliases:
...
### OpenHab.RestApi.Models.IPageDto
