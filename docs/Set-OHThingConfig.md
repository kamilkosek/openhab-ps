...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/set-ohthingconfig
schema: 2.0.0
---
...
```
Set-OHThingConfig -ThingUid <String> [-AcceptLanguage <String>] [-AdditionalProperties <Hashtable>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Set-OHThingConfig -ThingUid <String> -Body <Hashtable> [-AcceptLanguage <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-OHThingConfig -InputObject <IOpenHabRestApiIdentity> -Body <Hashtable> [-AcceptLanguage <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-OHThingConfig -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>]
