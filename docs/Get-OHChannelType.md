...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohchanneltype
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHChannelType [-Prefixes <String>] [-AcceptLanguage <String>] [<CommonParameters>]
```

### Get1
```
Get-OHChannelType -ChannelTypeUid <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHChannelType -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IChannelTypeDto
