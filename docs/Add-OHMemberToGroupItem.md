...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/add-ohmembertogroupitem
schema: 2.0.0
---

# Add-OHMemberToGroupItem
...
### Add (Default)
```
Add-OHMemberToGroupItem -Itemname <String> -MemberItemName <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### AddViaIdentity
```
Add-OHMemberToGroupItem -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
