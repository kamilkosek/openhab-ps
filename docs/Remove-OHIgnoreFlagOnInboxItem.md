...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohignoreflagoninboxitem
schema: 2.0.0
---

# Remove-OHIgnoreFlagOnInboxItem
...
### Remove (Default)
```
Remove-OHIgnoreFlagOnInboxItem -ThingUid <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHIgnoreFlagOnInboxItem -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
