...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohregistereduicomponent
schema: 2.0.0
---

# Get-OHRegisteredUiComponent
...
### Get (Default)
```
Get-OHRegisteredUiComponent -Namingroom <String> [-Summary] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHRegisteredUiComponent -InputObject <IOpenHabRestApiIdentity> [-Summary] [<CommonParameters>]
```
