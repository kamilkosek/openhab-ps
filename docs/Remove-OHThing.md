...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohthing
schema: 2.0.0
---
...
### Remove (Default)
```
Remove-OHThing -ThingUid <String> [-Force] [-AcceptLanguage <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHThing -InputObject <IOpenHabRestApiIdentity> [-Force] [-AcceptLanguage <String>] [-PassThru]
