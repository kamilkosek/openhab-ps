...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohtemplate
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHTemplate [-AcceptLanguage <String>] [<CommonParameters>]
```

### Get1
```
Get-OHTemplate -TemplateUid <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHTemplate -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.ITemplate
