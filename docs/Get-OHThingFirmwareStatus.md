...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohthingfirmwarestatus
schema: 2.0.0
---

# Get-OHThingFirmwareStatus
...
### Get (Default)
```
Get-OHThingFirmwareStatus -ThingUid <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHThingFirmwareStatus -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
