...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohservicecontext
schema: 2.0.0
---

# Get-OHServiceContext
...
### Get (Default)
```
Get-OHServiceContext -ServiceId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHServiceContext -InputObject <IOpenHabRestApiIdentity> [<CommonParameters>]
```
