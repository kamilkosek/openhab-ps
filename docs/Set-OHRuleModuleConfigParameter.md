...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/set-ohrulemoduleconfigparameter
schema: 2.0.0
---

# Set-OHRuleModuleConfigParameter
...
### Set (Default)
```
Set-OHRuleModuleConfigParameter -Id <String> -ModuleCategory <String> -Param <String> -RuleUid <String>
 -Data <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-OHRuleModuleConfigParameter -InputObject <IOpenHabRestApiIdentity> -Data <String> [-PassThru] [-Confirm]
