...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohsitemap
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHSitemap [<CommonParameters>]
```

### Get1
```
Get-OHSitemap -Sitemapname <String> [-IncludeHidden] [-Jsoncallback <String>] [-Type <String>]
 [-AcceptLanguage <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHSitemap -InputObject <IOpenHabRestApiIdentity> [-IncludeHidden] [-Jsoncallback <String>]
 [-Type <String>] [-AcceptLanguage <String>] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.ISitemapDto
