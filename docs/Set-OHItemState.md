...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/set-ohitemstate
schema: 2.0.0
---
...
### Update (Default)
```
Set-OHItemState -Itemname <String> -Data <String> [-AcceptLanguage <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-OHItemState -InputObject <IOpenHabRestApiIdentity> -Data <String> [-AcceptLanguage <String>] [-PassThru]
