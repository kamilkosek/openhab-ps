...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohrulemodule
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHRuleModule -Id <String> -ModuleCategory <String> -RuleUid <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHRuleModule -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IModuleDto
