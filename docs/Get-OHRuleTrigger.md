...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohruletrigger
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHRuleTrigger -RuleUid <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHRuleTrigger -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.ITriggerDto
