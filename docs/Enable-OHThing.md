...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/enable-ohthing
schema: 2.0.0
---
...
### Enable (Default)
```
Enable-OHThing -ThingUid <String> -Body <String> [-AcceptLanguage <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-OHThing -InputObject <IOpenHabRestApiIdentity> -Body <String> [-AcceptLanguage <String>] [-PassThru]
