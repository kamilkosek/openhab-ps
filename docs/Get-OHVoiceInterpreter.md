...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohvoiceinterpreter
schema: 2.0.0
---

# Get-OHVoiceInterpreter
...
### Get1 (Default)
```
Get-OHVoiceInterpreter [-AcceptLanguage <String>] [<CommonParameters>]
```

### Get
```
Get-OHVoiceInterpreter -Id <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHVoiceInterpreter -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IHumanLanguageInterpreterDto
