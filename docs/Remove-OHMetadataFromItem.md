...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohmetadatafromitem
schema: 2.0.0
---

# Remove-OHMetadataFromItem
...
### Remove (Default)
```
Remove-OHMetadataFromItem -Itemname <String> -Namingroom <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHMetadataFromItem -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
