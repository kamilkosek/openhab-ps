...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/install-ohaddonfromurl
schema: 2.0.0
---

# Install-OHAddonFromUrl
...
### Install (Default)
```
Install-OHAddonFromUrl -Url <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### InstallViaIdentity
```
Install-OHAddonFromUrl -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
