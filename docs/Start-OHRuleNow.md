...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/start-ohrulenow
schema: 2.0.0
---
...
### Run (Default)
```
Start-OHRuleNow -RuleUid <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RunViaIdentity
```
Start-OHRuleNow -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
