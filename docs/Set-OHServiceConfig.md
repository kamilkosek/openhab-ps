...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/set-ohserviceconfig
schema: 2.0.0
---
...
```
Set-OHServiceConfig -ServiceId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Set-OHServiceConfig -ServiceId <String> -Body <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-OHServiceConfig -InputObject <IOpenHabRestApiIdentity> -Body <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-OHServiceConfig -InputObject <IOpenHabRestApiIdentity> [-AdditionalProperties <Hashtable>] [-PassThru]
