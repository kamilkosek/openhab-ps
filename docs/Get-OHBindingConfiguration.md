...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohbindingconfiguration
schema: 2.0.0
---

# Get-OHBindingConfiguration
...
### Get (Default)
```
Get-OHBindingConfiguration -BindingId <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHBindingConfiguration -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
