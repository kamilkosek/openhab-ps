...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohuicomponent
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHUiComponent -ComponentUid <String> -Namingroom <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHUiComponent -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
