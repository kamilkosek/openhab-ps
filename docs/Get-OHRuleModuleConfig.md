...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohrulemoduleconfig
schema: 2.0.0
---

# Get-OHRuleModuleConfig
...
### Get (Default)
```
Get-OHRuleModuleConfig -Id <String> -ModuleCategory <String> -RuleUid <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHRuleModuleConfig -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
