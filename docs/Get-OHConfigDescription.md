...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohconfigdescription
schema: 2.0.0
---

# Get-OHConfigDescription
...
### Get (Default)
```
Get-OHConfigDescription [-Scheme <String>] [-AcceptLanguage <String>] [<CommonParameters>]
```

### Get1
```
Get-OHConfigDescription -Uri <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHConfigDescription -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IConfigDescriptionDto
