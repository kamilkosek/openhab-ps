...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohthingconfigstatus
schema: 2.0.0
---

# Get-OHThingConfigStatus
...
### Get (Default)
```
Get-OHThingConfigStatus -ThingUid <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHThingConfigStatus -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
