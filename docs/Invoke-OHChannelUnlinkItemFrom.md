...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/invoke-ohchannelunlinkitemfrom
schema: 2.0.0
---

# Invoke-OHChannelUnlinkItemFrom
...
### Channel (Default)
```
Invoke-OHChannelUnlinkItemFrom -ChannelUid <String> -Itemname <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ChannelViaIdentity
```
Invoke-OHChannelUnlinkItemFrom -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: ChannelViaIdentity
Aliases:
