...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohitemstate
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHItemState -Itemname <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHItemState -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
