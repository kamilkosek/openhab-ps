...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohservice
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHService [<CommonParameters>]
```

### Get1
```
Get-OHService -ServiceId <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHService -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IConfigurableServiceDto
