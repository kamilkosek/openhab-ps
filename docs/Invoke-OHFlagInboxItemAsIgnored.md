...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/invoke-ohflaginboxitemasignored
schema: 2.0.0
---

# Invoke-OHFlagInboxItemAsIgnored
...
### Flag (Default)
```
Invoke-OHFlagInboxItemAsIgnored -ThingUid <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FlagViaIdentity
```
Invoke-OHFlagInboxItemAsIgnored -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Parameter Sets: FlagViaIdentity
Aliases:
