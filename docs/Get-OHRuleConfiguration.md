...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohruleconfiguration
schema: 2.0.0
---

# Get-OHRuleConfiguration
...
### Get (Default)
```
Get-OHRuleConfiguration -RuleUid <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHRuleConfiguration -InputObject <IOpenHabRestApiIdentity> [-PassThru] [<CommonParameters>]
```
