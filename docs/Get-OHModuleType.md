...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohmoduletype
schema: 2.0.0
---
...
### Get (Default)
```
Get-OHModuleType [-Tags <String>] [-Type <String>] [-AcceptLanguage <String>] [<CommonParameters>]
```

### Get1
```
Get-OHModuleType -ModuleTypeUid <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHModuleType -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru]
 [<CommonParameters>]
```
...
### OpenHab.RestApi.Models.IModuleTypeDto
