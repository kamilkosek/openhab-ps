...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/get-ohaddon
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-OHAddon [-AcceptLanguage <String>] [<CommonParameters>]
```

### Get
```
Get-OHAddon -AddonId <String> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-OHAddon -InputObject <IOpenHabRestApiIdentity> [-AcceptLanguage <String>] [-PassThru] [<CommonParameters>]
```
