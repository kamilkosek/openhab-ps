...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/enable-ohrule
schema: 2.0.0
---
...
### Enable (Default)
```
Enable-OHRule -RuleUid <String> -Data <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-OHRule -InputObject <IOpenHabRestApiIdentity> -Data <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
