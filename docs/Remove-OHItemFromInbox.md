...
online version: https://docs.microsoft.com/en-us/powershell/module/openhabrestapi/remove-ohitemfrominbox
schema: 2.0.0
---

# Remove-OHItemFromInbox
...
### Remove (Default)
```
Remove-OHItemFromInbox -ThingUid <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-OHItemFromInbox -InputObject <IOpenHabRestApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
